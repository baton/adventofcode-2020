...
void parse_add_rule( ruleset_t & rules, std::string const & s )
{
...
int main( int argc, char * argv[] )
{
	...
	for( std::string s; std::getline( ifs, s ) && !s.empty(); )
		parse_add_rule( rules, s );

	parse_add_rule( rules, "8: 42 | 42 8" );
	parse_add_rule( rules, "11: 42 31 | 42 11 31" );
